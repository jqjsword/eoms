...
gulp.task("build", function() {
    ...
    createSpecList();
    createJsHintOptions();
    console.log('begin to createWorkers -------------')
    ...
    try {
        newDemos = child_process
            .execSync(
                ...
                tagVersion +
                " Apps/Sandcastle/gallery/*.html", { stdio: ["pipe", "pipe", "ignore"] }
            )
            .toString()
            .trim()
            .split("\n");
...
function buildCesiumViewer() {
    const cesiumViewerOutputDirectory = "c:/own/CSTK/Satellite/frontend";
    console.log(cesiumViewerOutputDirectory);
    mkdirp.sync(cesiumViewerOutputDirectory);
    let promise = Promise.join(
        rollup
        .rollup({
            input: "Apps/CesiumViewer/static/js/events.js",
            treeshake: {
        ...
        .then(function(bundle) {
            return bundle.write({
                file: "c:/own/CSTK/Satellite/frontend/static/js/events.js",
                format: "esm", //important!
            });
        })
    );
    promise = promise.then(function() {
        var dst = './static/Cesium';
        gulp.src("c:/own/CSTK/Satellite/frontend/static/js/events.js")
            .pipe(gulpInsert.prepend(copyrightHeader))
            .pipe(gulpReplace("../../../../Source", dst))
            .pipe(gulpReplace("localhost:8080/Apps/Cesiumviewer", 'localhost:8000'))
            .pipe(gulp.dest(cesiumViewerOutputDirectory + '/static/js'))
    }).then(function() {
        var dst = '../Cesium';
        gulp
            .src("Apps/CesiumViewer/static/css/CesiumViewer.css")
            .pipe(cleanCSS())
            .pipe(gulpReplace("../../../../Source", dst))
            .pipe(gulp.dest(cesiumViewerOutputDirectory + '/static/css'));
    }).then(function() {
        gulp
            .src("Apps/CesiumViewer/static/js/accessTable.js")
            .pipe(gulpReplace('licenseKey8080', 'licenseKey8000'))
            .pipe(gulpReplace('http://localhost:8000/GetAccessTable', 'GetAccessTable'))
        ...
        gulp.src(
            ...
            .pipe(gulp.dest(cesiumViewerOutputDirectory + '/static/Cesium'))
    }).then(function() {
        gulp.src(["Build/Cesium/Widgets/InfoBox/InfoBoxDescription.css"])
            .pipe(gulp.dest(cesiumViewerOutputDirectory + '/static/Cesium/Widgets/InfoBox'))
    });

    promise = promise.then(function() {
        const stream = mergeStream(
            // #we copy resource to dest dir, exclude the events.js, accessTable.js
            gulp.src([
                "Apps/CesiumViewer/static/**",
                "!Apps/CesiumViewer/static/js/events.js",
                "!Apps/CesiumViewer/static/js/accessTable.js",
                "!Apps/CesiumViewer/static/css/CesiumViewer.css"
            ], { base: "Apps/CesiumViewer", nodir: true, }),

            gulp.src([
                "Apps/CesiumViewer/**",
                "!Apps/CesiumViewer/**/*.js",
                "!Apps/CesiumViewer/**/*.css",
                "!Apps/CesiumViewer/static", //#already copyed
            ]),
            gulp.src(["web.config"])
        );
...
function buildDist() {
    ...
    promise = promise.then(function() {
        ...
        gulp.src("c:/own/CSTK/Satellite/frontend/static/js/events.js")
            .pipe(gulpInsert.prepend(copyrightHeader))
            .pipe(gulpReplace("../../../../Source", dst))
            .pipe(gulpReplace("http://localhost:8000/GetAllSatellites", "GetAllSatellites"))
            .pipe(gulpReplace("http://localhost:8000/GetAllFacilities", "GetAllFacilities"))
            .pipe(gulpReplace("http://localhost:8080/Apps/Cesiumviewer", 'http://8.140.186.145:8000'))
            .pipe(gulpReplace("ws://localhost:8000", 'ws://8.140.186.145:8000'))
            .pipe(gulp.dest(cesiumViewerOutputDirectory + '/static/js'))
    }).then(function() {
        var dst = '../Cesium';
        gulp
        ...
        gulp
            .src("Apps/CesiumViewer/static/js/taskSchedule.js")
            .pipe(gulpReplace('licenseKey8080', 'licensePublic'))
            .pipe(gulpReplace('http://localhost:8000/ScheduleOneStationMultipleStars', 'ScheduleOneStationMultipleStars'))
            .pipe(gulpUglify({ mangle: true, compress: true }))
            .pipe(gulp.dest(cesiumViewerOutputDirectory + '/static/js'))
    }).then(function() {
        gulp
            .src("Apps/CesiumViewer/static/js/taskSchedule_oneStar_multiStations.js")
            .pipe(gulpReplace('licenseKey8080', 'licensePublic'))
            .pipe(gulpReplace('http://localhost:8000/ScheduleOneStarMultipleStations', 'ScheduleOneStarMultipleStations'))
            .pipe(gulpUglify({ mangle: true, compress: true }))
            .pipe(gulp.dest(cesiumViewerOutputDirectory + '/static/js'))
    }).then(function() {
        gulp
    ...
    promise = promise.then(function() {
        const stream = mergeStream(
            ...
            gulp.src([
                ...
                "!Apps/CesiumViewer/static/js/events.js",
                "!Apps/CesiumViewer/static/js/accessTable.js",
                "!Apps/CesiumViewer/static/js/taskSchedule.js",
                "!Apps/CesiumViewer/static/js/taskSchedule_oneStar_multiStations.js",
                "!Apps/CesiumViewer/static/css/CesiumViewer.css"
            ], { base: "Apps/CesiumViewer", nodir: true, }),
