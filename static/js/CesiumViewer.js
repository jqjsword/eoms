...
function main() {
    /*
       ...
       */
    Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJiYmJmOTY0Zi1hOWI2LTQyOTctYjE2Mi0zZjMxODg5ZjJmNjgiLCJpZCI6ODc4LCJpYXQiOjE1MjYyMTkyMTV9.CP5tJHB7iYZ19C7WKzqzDSSTbnpOliYcAVmmMIzMXgI';
    ...
    try {
        ...
        viewer = new Viewer("cesiumContainer", {
            ...
            imageryProvider: new WebMapTileServiceImageryProvider({
                url: "http://t0.tianditu.com/img_w/wmts?service=wmts&request=GetTile&version=1.0.0&LAYER=img&tileMatrixSet=w&TileMatrix={TileMatrix}&TileRow={TileRow}&TileCol={TileCol}&style=default&format=tiles&tk=1692764f1011679e65751a650b11e7e2",
                layer: "tdtImgLayer",
                style: "default",
                format: "image/jpeg",
        ...
        viewer.scene.environmentState.isSunVisible = true;
